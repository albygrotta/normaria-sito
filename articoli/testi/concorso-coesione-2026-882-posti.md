...
- **Basta la laurea triennale.** Non serve la magistrale, anche se ovviamente è ammessa. È la condizione che apre il concorso a molte più persone di quante credano di poter partecipare.
- **Non serve esperienza professionale, e non serve risiedere al Sud.** Puoi vivere a Milano e concorrere per i posti in Sicilia.
...
- **25 quesiti tecnico-professionali**, sulle materie del bando
- **8 quesiti logico-deduttivi**, che non richiedono nozioni ma ragionamento
...
- **Fondi e programmazione europea** — i regolamenti dell'Unione sui fondi strutturali, cioè le regole con cui quei soldi possono essere spesi.
- **Opere pubbliche** — lavori pubblici, sistemi di realizzazione, tutela della salute e sicurezza nei cantieri, infrastrutture viarie, tecnica delle costruzioni.
- **Territorio e ambiente** — pianificazione urbanistica, legislazione edilizia e urbanistica, valutazione ambientale, rischio idrogeologico e sismico, gestione del territorio.
- **Beni e diritti** — beni culturali, estimo, catasto e topografia, occupazione ed espropriazione.
- **Trasversali** — inglese a livello B1 e competenze informatiche e digitali.
